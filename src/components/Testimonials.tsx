...
const testimonials = [
  {
    id: 1,
    content: "Our wedding was nothing short of magical. Every detail was executed flawlessly, and we couldn't be happier with how our special day turned out.",
    author: "Emily & James",
    date: "August 2023",
  ...
  {
    id: 2,
    content: "The team went above and beyond to ensure our wedding day was stress-free and perfect. The venue was exquisite, and the coordination was seamless.",
  ...
  {
    id: 3,
    content: "From the beautiful venue to the delicious catering, our wedding exceeded all expectations. We're so grateful for the amazing experience.",
      ...
      <div className="max-w-7xl mx-auto">
        <AnimatedSection className="text-center mb-12">
          ...
          <p className="text-charcoal/70 max-w-2xl mx-auto">
            Hear what our clients have to say about their wedding experiences.
          </p>
        </AnimatedSection>
